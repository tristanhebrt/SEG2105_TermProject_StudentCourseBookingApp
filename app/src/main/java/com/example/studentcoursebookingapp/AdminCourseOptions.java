    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.createCourse:
                ...
                try {
                    courseModel = new CourseModel(-1, et_courseCode.getText().toString(), et_courseName.getText().toString(), null, null, null, null, 0, 0);
                    ...
                    courseModel = new CourseModel(-1, "error", "error", "error", "error", "error", "error", -1, -1);
                }
